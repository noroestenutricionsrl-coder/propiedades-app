...
urlpatterns = [
    ...
    path('servicio-propiedad/<int:pk>/editar/', views.propiedad_servicio_editar, name='propiedad_servicio_editar'),
    path('servicio-propiedad/<int:pk>/eliminar/', views.propiedad_servicio_eliminar, name='propiedad_servicio_eliminar'),
